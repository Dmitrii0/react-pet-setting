...
-- ВАЖНО: Выполняйте команды по порядку!

-- 1. Удаление старых таблиц (если они существуют)
DROP TABLE IF EXISTS bookings CASCADE;
DROP TABLE IF EXISTS services CASCADE;

-- 2. Удаление старых функций и триггеров (если они существуют)
DROP FUNCTION IF EXISTS update_updated_at_column() CASCADE;

-- 3. Создание таблицы bookings
...
-- 8. Вставка начальных данных услуг
...
-- 9. ВАЖНО: Настройка Row Level Security (RLS)
